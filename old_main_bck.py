...
def playlist_download(url_list):
    """
    Receives a list of URLs and do a for loop for each one.
    :param url_list: List containing the URLs
    :return: nothing
    """
...
if __name__ == "__main__":
    ...
    while maintainer:
        ...
        if choice == 1:
            ...
            clear()
            print("Download single video selected... Press enter to return.\n")
            video_url = str(input("Video url to download.\n>: "))  # wait for user input,
